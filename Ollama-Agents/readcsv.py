...
#inserire @tool per langhcain sopra le funzioni
...
def cerca_ordine(numero_ordine):
    ...
    """
    numero_ordine = numero_ordine.upper() #risolve problema ord-0001 e ORD-0001
    risultato = ordini[
...
#con invoke restituisco il risultato
'''risultato = conta_ordini_per_stato.invoke({
    "stato": "in ritardo"
})
